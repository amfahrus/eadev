    ...
    function getAll($limit, $offset, $sidx, $sord, $cari, $search = "false") {
        ...
        $this->dataset_db->insert_logs(
										array(
											...
											'log_description' => 'User menampilkan data master unitkerja',
    ...
    public function insert($data) {
        ...
        $this->dataset_db->insert_logs(
										array(
											'log_username' => $this->session->userdata('ba_username'),
											'log_node' => $_SERVER['REMOTE_ADDR'],
											'log_description' => 'User menambahkan data master unitkerja',
    ...
    public function update($data, $id) {
        ...
        $this->dataset_db->insert_logs(
										array(
											'log_username' => $this->session->userdata('ba_username'),
											'log_node' => $_SERVER['REMOTE_ADDR'],
											'log_description' => 'User mengedit data master unitkerja',
											'log_params' => json_encode($data)
										)
									  );
        return $id;
    ...
    public function insert_akses($id, $data) {
        ...
        $this->dataset_db->insert_logs(
										array(
											'log_username' => $this->session->userdata('ba_username'),
											'log_node' => $_SERVER['REMOTE_ADDR'],
											'log_description' => 'User menambahkan hak master akses',
											'log_params' => json_encode($data)
										)
									  );
    }
    ...
    public function delete($id) {
        ...
        $this->dataset_db->insert_logs(
										array(
											'log_username' => $this->session->userdata('ba_username'),
											'log_node' => $_SERVER['REMOTE_ADDR'],
											'log_description' => 'User menghapus master unitkerja',
											'log_params' => json_encode(array('id_unitkerja' => $id))
										)
									  );
    }
