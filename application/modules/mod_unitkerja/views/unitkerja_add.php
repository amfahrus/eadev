<div class="content">
    <?= form_open("mod_unitkerja/unitkerja_add"); ?>
    <div class="row-fluid">
        <div class="span12">
            <div class="box">
                ...
                <div class="basic box_content form-horizontal">
                    <div class="row-fluid">
                        <div class="control-group info">
                            ...
                            <div class="controls">
                                <input class="span8 text" type="text" id="nama_unitkerja" name="nama_unitkerja" value="<?= set_value('nama_unitkerja'); ?>" autocomplete="off" />
                            </div>
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="control-group info">
                            ...
                            <div class="controls">
                                <input class="span8 text" type="text" id="keterangan" name="keterangan" value="<?= set_value('keterangan'); ?>" autocomplete="off" />
                            </div>
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="control-group info">
                            ...
                            <div class="controls">
                                ...
                                foreach ($hak_akses as $value) {
                                    echo '<label class="checkbox"><input type="checkbox" class="checktree" name="hak_akses[]" value="' . $value['id_subunitkerja'] . '" >' . $value['nama_subunit'] . '</label>';
                                }
                                ?>
                            </div>
                        </div>
...
<script type="text/javascript">
    function formUnitKerjaAddClear() {
        $('input[name="nama_unitkerja"]').val("");
    ...
    $(document).ready(function() {
        $('button[name="form_unitkerja_save"]').bind('click', function() {
            $.ajax({
                url: root + 'mod_unitkerja/unitkerja_add',
                type: 'post',
                dataType: 'json',
                data: $("form").serialize(),
                beforeSend: function() {
