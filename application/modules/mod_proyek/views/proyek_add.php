<div class="content">
    <?= form_open("mod_proyek/proyek_add"); ?>
    <div class="row-fluid">
        <div class="span12">
            <div class="box">
                <div class="basic box_title"><h4><span>#</span> Master Proyek Add</h4></div>
                <div class="basic box_content form-horizontal">
                    <div class="row-fluid">
                        <div class="control-group info">
                            <label class="control-label" for="kode_proyek">Kode Proyek</label>
                            <div class="controls">
                                <input class="span8 text" type="text" id="kode_proyek" name="kode_proyek" value="<?= set_value('kode_proyek'); ?>" autocomplete="off" />
                            </div>
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="control-group info">
                            ...
                            <div class="controls">
                                <?= form_dropdown('id_katproyek', $id_katproyek, set_value('id_katproyek'), 'id="id_katproyek"'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="control-group info">
                            ...
                            <div class="controls">
                                <?= form_dropdown('jenisproyek_id', $jenisproyek_id, set_value('jenisproyek_id'), 'id="jenisproyek_id"'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="control-group info">
                            ...
                            <div class="controls">
                                <?= form_dropdown('id_subunitkerja', $id_subunitkerja, set_value('id_subunitkerja'), 'id="id_subunitkerja"'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="control-group info">
                            ...
                            <div class="controls">
                                <input class="span8 text" type="text" id="nama_proyek" name="nama_proyek" value="<?= set_value('nama_proyek'); ?>" autocomplete="off" />
                            </div>
                        </div>
                    </div>
                    <div class="row-fluid">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('button[name="form_proyekadd_save"]').bind('click', function() {
            ...
            $.ajax({
                url: root + 'mod_proyek/proyek_add',
                type: 'post',
                dataType: 'json',
                data: {
