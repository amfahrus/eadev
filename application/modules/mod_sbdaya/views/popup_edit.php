<div class="content popup_sbdaya_edit">
                ...
                <div class="basic box_content form-horizontal">
                    <div class="row-fluid">
                        <div class="control-group info">
                            ...
                            <div class="controls">
                                <input class="span8 text" type="text" id="kode_sbdaya" name="kode_sbdaya" value="<?= $detail["kode_sbdaya"]; ?>" readonly/>
                            </div>
                        </div>
                    </div>
                    <div class="row-fluid">
        ...
        $('button[name="form_sbdaya_save"]').bind('click', function() {
            $.ajax({
                ...
                success : function(json) {
                    $('div.alert').remove();
                    if (json['error']) {
                        $('.popup_sbdaya_edit').prepend('<div class="alert alert-error"><button type="button" class="close" data-dismiss="alert">&times;</button>'+json['error']+'</div>');
                        $('div.alert').fadeIn('slow');
                    }
                    if (json['success']) {
                        $('.popup_sbdaya_edit').prepend('<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">&times;</button>'+json['success']+'</div>');
                        $('div.alert').fadeIn('slow');
