    ...
    public function insert_users($data) {
        ...
        $this->dataset_db->insert_logs(
										array(
											...
											'log_description' => 'User menambahkan pengguna',
    ...
    public function insert_userdata($data) {
        ...
        $this->dataset_db->insert_logs(
										array(
											'log_username' => $this->session->userdata('ba_username'),
											'log_node' => $_SERVER['REMOTE_ADDR'],
											'log_description' => 'User menambahkan data pengguna',
											'log_params' => json_encode($data)
										)
									  );
        return $this->db->insert_id();
    ...
    public function update_user($data, $id) {
        ...
        $this->dataset_db->insert_logs(
										array(
											'log_username' => $this->session->userdata('ba_username'),
											'log_node' => $_SERVER['REMOTE_ADDR'],
											'log_description' => 'User mengganti pengguna',
											'log_params' => json_encode($data)
										)
									  );
        return $id;
    ...
    public function update_userdata($data, $id) {
        ...
        $this->dataset_db->insert_logs(
										array(
											'log_username' => $this->session->userdata('ba_username'),
											'log_node' => $_SERVER['REMOTE_ADDR'],
											'log_description' => 'User mengganti data pengguna',
											'log_params' => json_encode($data)
										)
									  );
        return $id;
    ...
    public function get($id) {
        ...
        $this->dataset_db->insert_logs(
										array(
											'log_username' => $this->session->userdata('ba_username'),
											'log_node' => $_SERVER['REMOTE_ADDR'],
											'log_description' => 'User menampilkan data pengguna berdasarkan ID',
											'log_params' => json_encode(array('user_id' => $id))
										)
									  );
        if ($query->num_rows() > 0) {
            $row = $query->row_array();
    ...
    function getAll($limit, $offset, $sidx, $sord, $cari, $search = "false") {
        ...
        $this->dataset_db->insert_logs(
										array(
											'log_username' => $this->session->userdata('ba_username'),
											'log_node' => $_SERVER['REMOTE_ADDR'],
											'log_description' => 'User menampilkan semua data pengguna',
    ...
    public function delete($id) {
        ...
        $this->dataset_db->insert_logs(
										array(
											'log_username' => $this->session->userdata('ba_username'),
											'log_node' => $_SERVER['REMOTE_ADDR'],
											'log_description' => 'User menghapus data pengguna',
											'log_params' => json_encode(array('user_id' => $id))
										)
									  );
    }
    ...
    public function UpdateConfigUser($data, $item = "") {
        ...
        $this->dataset_db->insert_logs(
										array(
											'log_username' => $this->session->userdata('ba_username'),
											'log_node' => $_SERVER['REMOTE_ADDR'],
											'log_description' => 'User mengganti domain',
											'log_params' => json_encode($data)
										)
									  );
        return $item;
