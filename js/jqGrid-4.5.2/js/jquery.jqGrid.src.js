...
(function($) {
    ...
    $.fn.fmatter.test = function(cellval, opts) {
        console.log(opts);
        return "<select class=\"ui-pg-selbox\"><option>Sangat Baik</option><option>2</option><option>3</option><option>4</option><select/>";
    };
                ...
                if (o.url === 'clientArray') {
                    ...
                    $.ajax($.extend({
                        ...
                        success: function(response) {
                            $('div.alert').remove();
                            if (response['error']) {
                                $('.content').prepend('<div class="alert alert-error"><button type="button" class="close" data-dismiss="alert">&times;</button>' + response['error'] + '</div>');
                                $('div.alert').fadeIn('slow');
                            }
                            if (response['success']) {
                                $('.content').prepend('<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">&times;</button>' + response['success'] + '</div>');
                                $('div.alert').fadeIn('slow');
                            }
                            scrollup();
